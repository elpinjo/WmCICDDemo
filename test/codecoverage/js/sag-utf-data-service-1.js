    ...
    app.service('pb$dataservice', function () {
        return function (result) {
            var myfunc = function (instruction) {
                ...
                instruction.childCount = instruction.childCount != undefined? Math.max(instruction.childCount, 0) : 0;
                instruction.visitCount = instruction.visitCount != undefined? Math.max(instruction.visitCount, 0) : 0;
                instruction.visitedChildCount = instruction.visitedChildCount != undefined ? Math.max(instruction.visitedChildCount, 0) : 0;
            ...
            var global_scope = lo_stats.childCount != undefined ? lo_stats.childCount : 0;
            var packages = lo_stats.SubInstruction;
            ...
            if (packages != undefined) {
                packages.forEach(function(package) {
                    package.instruction.childCount = package.instruction.childCount != undefined? Math.max(package.instruction.childCount, 0) : 0;
                    package.instruction.visitedChildCount = package.instruction.visitedChildCount != undefined ? Math.max(package.instruction.visitedChildCount, 0) : 0;
    ...
    app.service('imageproviderservice', function () {
        return function (scope) {
            ...
            scope.images = {
                ...
                xsltservice_unknown: "images/ns_xsltservice.gif",
